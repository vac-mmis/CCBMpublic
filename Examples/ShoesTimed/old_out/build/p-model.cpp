...
bool finished0(double _1, double *p=NULL) { return normalModel(_1,5,2,p); }
bool finished1(double _1, double *p=NULL) { return normalModel(_1,5,2,p); }
bool finished2(double _1, double *p=NULL) { return normalModel(_1,2,1,p); }
bool finished3(double _1, double *p=NULL) { return normalModel(_1,2,1,p); }
bool finishedImmediate(double, double* p) { if (p)*p=1.0; return true; }
double pStopcdf0(double startTime, double curTime) { return normalcdf(curTime- startTime,5,2); }
double pStopcdf1(double startTime, double curTime) { return normalcdf(curTime- startTime,5,2); }
double pStopcdf2(double startTime, double curTime) { return normalcdf(curTime- startTime,2,1); }
double pStopcdf3(double startTime, double curTime) { return normalcdf(curTime- startTime,2,1); }
double pStopcdfImmediate(double startTime, double curTime){ return (curTime > startTime) ? 1.0 : 0.0; }
double pStoppdf0(double startTime, double curTime) { return normalpdf(curTime - startTime,5,2); }
double pStoppdf1(double startTime, double curTime) { return normalpdf(curTime - startTime,5,2); }
double pStoppdf2(double startTime, double curTime) { return normalpdf(curTime - startTime,2,1); }
double pStoppdf3(double startTime, double curTime) { return normalpdf(curTime - startTime,2,1); }
...
const ActionSchemes::S_putOnSock a_putOnSock_right(0, "(putOnSock right)", action_putOnSock_right, callback_putOnSock_right, getRecOrRefr0, finished0, pStopcdf0, pStoppdf0, -1 /* bad time model (normal 5 2) in 0 */);
const ActionSchemes::S_putOnSock a_putOnSock_left(1, "(putOnSock left)", action_putOnSock_left, callback_putOnSock_left, getRecOrRefr1, finished1, pStopcdf1, pStoppdf1, -1 /* bad time model (normal 5 2) in 1 */);
const ActionSchemes::S_putOnShoe a_putOnShoe_right(2, "(putOnShoe right)", action_putOnShoe_right, callback_putOnShoe_right, getRecOrRefr2, finished2, pStopcdf2, pStoppdf2, -1 /* bad time model (normal 2 1) in 2 */);
const ActionSchemes::S_putOnShoe a_putOnShoe_left(3, "(putOnShoe left)", action_putOnShoe_left, callback_putOnShoe_left, getRecOrRefr3, finished3, pStopcdf3, pStoppdf3, -1 /* bad time model (normal 2 1) in 3 */);
} // namespace Actions
