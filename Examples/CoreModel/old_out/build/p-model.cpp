...
char const * const initialStateNames[] = {"i11"};
char const * const goalNames[] = {"A"};
...
const ActionSchemes::S_step a_step_55_54(79, "(step 55 54)", action_step_55_54, NULL, getRecOrRefr79, finishedImmediate, pStopcdfImmediate, pStoppdfImmediate, 0.0 /* 79 */);
} // namespace Actions
